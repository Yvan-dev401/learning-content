...
[![Construire des applications de génération d'images](@img/09-lesson-banner.webp)](https://youtu.be/B5VP0_J7cs8?si=5P3L5o7F_uS_QcG9)
...
![Startup Edu4All, classe sur les monuments, Tour Eiffel](@img/startup.webp)
...
[DALL-E](https://openai.com/dall-e-2) et [Midjourney](https://www.midjourney.com/) sont deux des modèles de génération d'images les plus populaires, permettant d'utiliser des prompts pour générer des images.

### DALL-E

Commençons par DALL-E, qui est un modèle d'IA générative capable de créer des images à partir de descriptions textuelles.

> [DALL-E est une combinaison de deux modèles, CLIP et attention diffusée](https://towardsdatascience.com/openais-dall-e-and-clip-101-a-brief-introduction-3a4367280d4e).
...
![Image générée par Midjourney, pigeon mécanique](https://upload.wikimedia.org/wikipedia/commons/thumb/8/8c/Rupert_Breheny_mechanical_dove_eca144e7-476d-4976-821d-a49c408e4f36.png/440px-Rupert_Breheny_mechanical_dove_eca144e7-476d-4976-821d-a49c408e4f36.png)
_Crédit image Wikipedia, image générée par Midjourney_

## Comment fonctionnent DALL-E et Midjourney

Tout d'abord, [DALL-E](https://arxiv.org/pdf/2102.12092.pdf). DALL-E est un modèle d'IA générative basé sur l'architecture transformer avec un _transformer autoregressif_.
...
<div style="display: flex; justify-content: space-between; align-items: center; margin: 20px 0;">
  <img src="@img/sunlit_lounge.webp" style="width: 30%; max-width: 200px; height: auto;">
  <img src="@img/mask.webp" style="width: 30%; max-width: 200px; height: auto;">
  <img src="@img/sunlit_lounge_result.webp" style="width: 30%; max-width: 200px; height: auto;">
</div>
...
![Lapin sur un cheval tenant une sucette, version 1](@img/v1-generated-image.webp)

Maintenant, exécutons ce même prompt pour voir que nous n'obtenons pas deux fois la même image :

![Image générée de lapin sur un cheval](@img/v2-generated-image.webp)
...
- ![Température 0, v1](@img/v1-temp-generated-image.webp)
- ![Température 0, v2](@img/v2-temp-generated-image.webp)
...
Rendez-vous à la leçon 10 où nous verrons comment [créer des applications d'IA avec peu de code](@lesson/10-building-low-code-ai-applications)
