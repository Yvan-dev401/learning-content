...
[![Création de prompts avancés](@img/05-lesson-banner.webp)](https://youtu.be/BAjzkaCdRok?si=NmUIyRf7-cDgbjtt)
...
[Solution](@code/05-advanced-prompts/python/aoai-solution.py)
...
Après avoir terminé cette leçon, consultez notre [collection d’apprentissage de l’IA générative](https://aka.ms/genai-collection) pour continuer à progresser dans votre connaissance de l’IA générative !

Rendez-vous à la Leçon 6 où nous appliquerons nos connaissances en Prompt Engineering en [créant des applications de génération de texte](@lesson/06-text-generation-apps)
