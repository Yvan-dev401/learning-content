...
- Assurez-vous que toutes vos URLs sont encadrées par des crochets suivis de parenthèses sans espaces supplémentaires autour ou à l’intérieur `[](@home)`.  
...
- [Check Broken Relative Paths](@home)  
- [Check Paths Have Tracking](@home)  
- [Check URLs Have Tracking](@home)  
- [Check URLs Don't Have Locale](@home)
...
![VS code follow links screenshot](@img/vscode-follow-link.webp)
...
![VS code select relative path screenshot](@img/vscode-select-relative-path.webp)
...
![GitHub check paths missing tracking comment screenshot](@img/github-check-paths-missing-tracking-comment.webp)
...
![GitHub check urls missing tracking comment screenshot](@img/github-check-urls-missing-tracking-comment.webp)
...
![GitHub check country locale comment screenshot](@img/github-check-country-locale-comment.webp)
