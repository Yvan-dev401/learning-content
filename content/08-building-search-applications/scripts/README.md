...
> Voir la [Documentation](https://learn.microsoft.com/cli/azure/update-azure-cli)
...
- [Python 3.9](https://www.python.org/downloads/) ou version supérieure
...
1. Installez le [client git](https://git-scm.com/downloads) s’il n’est pas déjà installé.
