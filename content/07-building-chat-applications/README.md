...
[![Construire des applications de chat alimentées par l'IA générative](@img/07-lesson-banner.webp)](https://youtu.be/R9V0ZY1BEQo?si=IHuU-fS9YWT8s4sA)
...
- **Surveillance**. Une fois déployées, comment pouvons-nous surveiller et garantir que les applications fonctionnent au plus haut niveau de qualité, tant en termes de fonctionnalité que de respect des [six principes de l'IA responsable](https://www.microsoft.com/ai/responsible-ai) ?
...
![Paramètres d'instructions personnalisées dans ChatGPT](@img/custom-instructions.webp)
...
![Une invite dans ChatGPT pour un plan de cours sur les listes chaînées](@img/lesson-plan-prompt.webp)

### Cadre de message système de Microsoft pour les modèles de langage étendu

[Microsoft a fourni des conseils](https://learn.microsoft.com/azure/ai-services/openai/concepts/system-message#define-the-models-output-format) pour rédiger des messages système efficaces lors de la génération de réponses à partir de modèles de langage étendu, décomposés en 4 domaines :
...
Voir [devoir](@lesson/07-building-chat-applications#code). Il vous guidera à travers une série d'exercices allant de l'exécution de vos premières invites de chat, à la classification et au résumé de texte, et plus encore. Notez que les devoirs sont disponibles dans différents langages de programmation !
...
Rendez-vous à la leçon 8 pour découvrir comment commencer à [créer des applications de recherche](@lesson/08-building-search-applications) !
