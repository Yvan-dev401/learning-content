...
Les devoirs **peuvent** également être configurés pour fonctionner avec un ou plusieurs déploiements de grands modèles de langage (LLM) via un fournisseur de services pris en charge comme OpenAI, Azure ou Hugging Face. Ceux-ci fournissent un _point de terminaison hébergé_ (API) auquel nous pouvons accéder de manière programmatique avec les bonnes informations d'identification (clé API ou jeton). Dans ce cours, nous abordons ces fournisseurs :
 ...
 - [OpenAI](https://platform.openai.com/docs/models) avec divers modèles incluant la série principale GPT.
 - [Azure OpenAI](https://learn.microsoft.com/azure/ai-services/openai/) pour les modèles OpenAI avec un focus sur la préparation entreprise
 - [Hugging Face](https://huggingface.co/docs/hub/index) pour les modèles open-source et le serveur d'inférence
...
|:---|:---|:---|:---|:---|
| [OpenAI](https://platform.openai.com/signup)| [Tarification](https://openai.com/pricing#language-models)| [Basée sur projet](https://platform.openai.com/api-keys) | [Sans code, Web](https://platform.openai.com/playground) | Plusieurs modèles disponibles |
| [Azure](https://aka.ms/azure/free)| [Tarification](https://azure.microsoft.com/pricing/details/cognitive-services/openai-service/)| [Démarrage rapide SDK](https://learn.microsoft.com/azure/ai-services/openai/quickstart)| [Démarrage rapide Studio](https://learn.microsoft.com/azure/ai-services/openai/quickstart) |  [Doit postuler à l'avance pour l'accès](https://learn.microsoft.com/azure/ai-services/openai/)|
| [Hugging Face](https://huggingface.co/join) | [Tarification](https://huggingface.co/pricing) | [Jetons d'accès](https://huggingface.co/docs/hub/security-tokens) | [Hugging Chat](https://huggingface.co/chat/)| [Hugging Chat a des modèles limités](https://huggingface.co/chat/models) |
| | | | | |
...
Les valeurs du point de terminaison et de la clé Azure OpenAI se trouvent dans le [portail Azure](https://portal.azure.com), commençons donc par là.
...
1. Naviguez vers [Azure OpenAI Studio](https://oai.azure.com) **depuis votre ressource** comme décrit ci-dessus.
