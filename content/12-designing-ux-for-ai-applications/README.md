...
[![Concevoir l'expérience utilisateur pour les applications d'IA](@img/12-lesson-banner.webp)](https://youtu.be/VKbCejSICA8?si=MKj7GQYHfXRZyWW6)
...
Prenez le temps de lire davantage sur [l'expérience utilisateur et la pensée design.](https://learn.microsoft.com/training/modules/ux-design)
...
![image illustrant les considérations UX dans l'IA](@img/uxinai.webp)
...
![page d'accueil d'une application avec une illustration claire de l'explicabilité dans les applications d'IA](@img/explanability-in-ai.webp)
...
![L'IA répond aux questions en fonction du rôle](@img/solving-questions.webp)
...
![explications simplifiées sur les capacités de l'IA](@img/simplified-explanations.webp)
...
![Résultats de recherche Bing avec des options pour modifier la requête et le résultat](@img/bing1.webp)
...
![Résultats de recherche Bing avec des options pour modifier la requête et le résultat](@img/bing2.webp)
...
![Donner des retours et gérer les erreurs](@img/feedback-loops.webp)
...
Rendez-vous à la leçon 13, où nous examinerons comment [sécuriser les applications d'IA](@lesson/13-securing-ai-applications) !
