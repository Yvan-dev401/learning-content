...
- [Product Review Agent](@apppage/ai-agent-framework-crash-course/openai-sdk-crash-course/2-structured-output-agent-2-2-product-review-agent) - Complex structured output
- [Email Generator Agent](@apppage/ai-agent-framework-crash-course/openai-sdk-crash-course/2-structured-output-agent) - Simple structured output
- [Tutorial 3: Tool Using Agent](@apppage/ai-agent-framework-crash-course/openai-sdk-crash-course/3-tool-using-agent) - Adding tools to agents
