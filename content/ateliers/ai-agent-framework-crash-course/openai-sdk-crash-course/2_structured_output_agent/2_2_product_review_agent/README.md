...
- [Support Ticket Agent](@apppage/ai-agent-framework-crash-course/openai-sdk-crash-course/2-structured-output-agent-2-1-support-ticket-agent) - Basic structured output
