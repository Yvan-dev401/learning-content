...
- **[Tutorial 2: Structured Output Agent](@apppage/ai-agent-framework-crash-course/openai-sdk-crash-course/2-structured-output-agent)** - Learn to create type-safe, structured responses
- **[Tutorial 3: Tool Using Agent](@apppage/ai-agent-framework-crash-course/openai-sdk-crash-course/3-tool-using-agent)** - Add custom tools and functions to your agent
- **[Tutorial 4: Runner Execution Methods](@apppage/ai-agent-framework-crash-course/openai-sdk-crash-course/4-running-agents)** - Master different execution patterns
