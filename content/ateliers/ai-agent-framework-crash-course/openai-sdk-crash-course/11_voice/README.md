...
- **[Agent Fundamentals](@apppage/ai-agent-framework-crash-course/openai-sdk-crash-course/1-starter-agent)**: Basic agent concepts
- **[Multi-Agent Systems](@apppage/ai-agent-framework-crash-course/openai-sdk-crash-course/9-multi-agent-orchestration)**: Agent handoffs and orchestration
