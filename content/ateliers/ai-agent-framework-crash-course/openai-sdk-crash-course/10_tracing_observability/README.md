...
- **[Tutorial 9: Handoffs & Delegation](@apppage/ai-agent-framework-crash-course/openai-sdk-crash-course/8-handoffs-delegation)** - Agent handoffs and task delegation
- **[Tutorial 10: Multi-Agent Orchestration](@apppage/ai-agent-framework-crash-course/openai-sdk-crash-course/9-multi-agent-orchestration)** - Complex multi-agent workflows
