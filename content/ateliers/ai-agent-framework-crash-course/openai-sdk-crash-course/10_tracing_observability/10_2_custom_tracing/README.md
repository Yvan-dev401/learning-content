...
- [Default Tracing](@apppage/ai-agent-framework-crash-course/openai-sdk-crash-course/10-tracing-observability-10-1-default-tracing) - Basic tracing fundamentals
- [Tutorial 11: Production Patterns](@apppage/ai-agent-framework-crash-course/openai-sdk-crash-course/11-voice) - Real-world deployment
