...
- [Built-in Tools](@apppage/ai-agent-framework-crash-course/openai-sdk-crash-course/3-tool-using-agent-3-2-builtin-tools) - SDK provided tools
- [Tutorial 4: Running Agents](@apppage/ai-agent-framework-crash-course/openai-sdk-crash-course/4-running-agents) - Advanced execution patterns
