...
- **[Tutorial 5: Context Management](@apppage/ai-agent-framework-crash-course/openai-sdk-crash-course/5-context-management)** - Manage state across interactions
- **[Tutorial 6: Guardrails & Validation](@apppage/ai-agent-framework-crash-course/openai-sdk-crash-course/6-guardrails-validation)** - Add safety and validation
