...
- [Function Tools](@apppage/ai-agent-framework-crash-course/openai-sdk-crash-course/3-tool-using-agent-3-1-function-tools) - Custom function tools
- [Agents as Tools](@apppage/ai-agent-framework-crash-course/openai-sdk-crash-course/3-tool-using-agent-3-3-agents-as-tools) - Advanced orchestration patterns
