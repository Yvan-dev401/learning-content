...
1. **[5_1_in_memory_conversation](@apppage/ai-agent-framework-crash-course/google-adk-crash-course/5-memory-agent-5-1-in-memory-conversation-agent)** - Basic session management
   - InMemorySessionService for temporary conversations
   - Simple state management
   - Event tracking basics

2. **[5_2_persistent_conversation](@apppage/ai-agent-framework-crash-course/google-adk-crash-course/5-memory-agent-5-2-persistent-conversation-agent)** - Database persistence
