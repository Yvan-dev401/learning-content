...
- **[Tutorial 4: Memory Agent](@apppage/ai-agent-framework-crash-course/google-adk-crash-course/5-memory-agent)** - Add memory capabilities
- **[Tutorial 5: Workflow Agent](@apppage/ai-agent-framework-crash-course/google-adk-crash-course/7-plugins)** - Multi-step processes
- **[Tutorial 6: Multi-agent System](@apppage/ai-agent-framework-crash-course/google-adk-crash-course/8-simple-multi-agent)** - Agent collaboration
