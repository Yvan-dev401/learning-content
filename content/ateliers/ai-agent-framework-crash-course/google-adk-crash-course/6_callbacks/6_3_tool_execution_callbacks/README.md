...
- **[Advanced Tool Patterns](@apppage/ai-agent-framework-crash-course/google-adk-crash-course/4-tool-using-agent)** - Complex tool architectures
- **[Custom Tool Development](@apppage/ai-agent-framework-crash-course/google-adk-crash-course/4-tool-using-agent)** - Building custom tools
- **[Tool Integration](@apppage/ai-agent-framework-crash-course/google-adk-crash-course/4-tool-using-agent)** - Integrating external APIs
