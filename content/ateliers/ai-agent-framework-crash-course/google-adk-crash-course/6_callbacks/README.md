...
- **[Advanced Agent Patterns](@apppage/ai-agent-framework-crash-course/google-adk-crash-course/6-callbacks)** - Complex agent architectures
- **[Production Deployment](@apppage/ai-agent-framework-crash-course/google-adk-crash-course/7-plugins)** - Deploying agents to production
- **[Custom Tools](@apppage/ai-agent-framework-crash-course/google-adk-crash-course/4-tool-using-agent)** - Building custom tools and integrations
