...
To test the example, copy the contents of [`test-input.json`](@appcode/generative-ui-agents/ai-mcp-app-builder/apps/threejs-server/test-input.json) into the tool input field in `basic-host`.
